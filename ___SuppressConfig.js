class SuppressConfig {
    ...
    static var ReportBaseSuppressValue = 10;  // Min number of responses (response = question specified below in Survey Config -> Response: {qId: 'status', codes: ['complete']})

    static var TableSuppressValue = 10;        // Min number of answers in the Aggregated Table
    ...
    static var CategoricalSuppressValue = 10; // Min number of answers for cards on the Categorical page
